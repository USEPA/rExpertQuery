...
![A screenshot of the web page to sign up for your uniruq Expert Query API Key](images/apikey.png){width="6.5in" height="4.64in"}
...
![A screenshot of the Expert Query user interface with the dropdown menu open to dipslay the profile options.](images/EQprofiles.png){width="6.5in"}
...
![A screenshot of the Expert Query National Downloads web page](images/nat.downloads.png){width="6.5in"}
...
contain a value for monitoringLocationId and are relevant to states. The
resulting data frame, called "filtered.mls" will allow us to determine
(1) which organizations have included monitoringLocationIdentifiers and
(2) which organizations have included monitoringLocationDataLinks.
...
Of these states, `r nrow(links.mls)` also contain
...
states with monitoringLocationIdentifiers in blue and those with
...
*Fig 3. New category 5 waters in 2024, summarized by their 2022
categories.*
