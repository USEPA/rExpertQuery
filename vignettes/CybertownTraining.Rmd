...
remotes::install_github("USEPA/rExpertQuery", ref = "formatupdates", dependencies = TRUE, force = TRUE)
...
Key](images/apikey.png){width="3.25in" height="2.32in"}
...
2.  **Are there active assessmentUnits without any listed
    ...
    There are `r dplyr::n_distinct(no.ml.ak$assessmentUnitId)` active
    assessmentUnits in Alaska without monitoringLocations listed in
    ATTAINS.
...
1.  **Which states in Region 6 have listed probable Sources in their
    ...
    ```{r r6.sources, results=FALSE, message=FALSE}
...
2.  **What are the most commonly listed sources in the latest report
    ...
    ```{r source.sum, results=TRUE, message=FALSE}
