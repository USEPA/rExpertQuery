...
listed below, grouped by the rExpertQuery function that will be used to
answer them.

### EQ_NationalExtract {.unlisted .unumbered}
...
### EQ_Assessments {.unlisted .unumbered}
...
### EQ_AssessmentUnits {.unlisted .unumbered}

1.  What are the retired assessment units for Florida?

### EQ_TMDLs {.unlisted .unumbered}
...
### EQ_ActionsDocuments {.unlisted .unumbered}
...
2.  **Which waters are impaired for SELENIUM nationally? Which states
    ...
    DT::data.table(param.nat, options = list(pageLength = 10, scrollX = TRUE))
...
3.  **Which waters have a TMDL and are fully supporting nationally?**
    ...
    DT::data.table(tmdls.fs, options = list(pageLength = 10, scrollX = TRUE))
    ```
