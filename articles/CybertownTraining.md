...
```
    ...
    ## 
    ## ── R CMD build ─────────────────────────────────────────────────────────────────
    ## * checking for file ‘/tmp/Rtmp3cMkEq/remotes1fe1547ceb36/USEPA-rExpertQuery-d763258/DESCRIPTION’ ... OK
...
1.  **What is the most commonly reported impairment nationally?**
    ...
    ```
        ...
        ## [1] "EQ_NationalExtract: downloading Assessments Profile (Expert Query National Extract). It was last updated on July 10, 2026 at 09:28 PM EDT."
...
1.  **What are all the actions documents that contain the keyword
    ...
    This query yields 16,985 results. As well as providing the actionId
