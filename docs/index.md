...
[![Codecov test
coverage](https://codecov.io/gh/USEPA/rExpertQuery/graph/badge.svg)](https://app.codecov.io/gh/USEPA/rExpertQuery)

A draft R package (UNDER ACTIVE DEVELOPMENT) for retrieving ATTAINS data
